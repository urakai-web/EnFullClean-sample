    ...
    <footer className="bg-navy-dark py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between gap-8 mb-10">
          ...
          <div>
            <h3 className="text-white font-bold mb-4 text-sm">サービス情報</h3>
            <dl className="text-sm text-white/70 space-y-2">
              <div className="flex gap-3">
                <dt className="text-white/40 w-20 shrink-0">対応エリア</dt>
                <dd>福岡市・糸島市・春日市・大野城市 他</dd>
              </div>
              <div className="flex gap-3">
                <dt className="text-white/40 w-20 shrink-0">ご予約</dt>
                <dd>公式LINE または Instagram DM</dd>
              </div>
              <div className="flex gap-3">
                <dt className="text-white/40 w-20 shrink-0">お支払い</dt>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2 text-sm text-white/70 mb-6">
              ...
              <a href="#reviews" className="hover:text-white transition-colors">口コミ</a>
        ...
        <div className="border-t border-white/10 pt-6 text-center text-white/30 text-xs">
          &copy; {new Date().getFullYear()} EnFullClean All Rights Reserved.
        </div>
      </div>
    </footer>
  )
