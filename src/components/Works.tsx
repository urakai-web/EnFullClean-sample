...
const works = [
  {
    ...
    title: 'エアコンクリーニング',
    description: '内部に蓄積した黒カビ・ほこり・臭いを高圧洗浄で徹底分解。効きも改善し、電気代の節約にも。',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    title: 'キッチン換気扇クリーニング',
    description: '換気扇・レンジフード内部の頑固な油汚れをしっかり除去。清潔なキッチンを取り戻します。',
  },
]
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-5 text-navy/70 leading-relaxed">
            エアコンクリーニングを中心に、水回りなど幅広く対応しています。<br className="hidden md:block" />
            作業の様子は
            <a
              href={INSTAGRAM_URL}
              target="_blank"
